...
import { ClipboardList, FilePlus, FileText, IndianRupee } from 'lucide-react'
...
const OrderMain = ({ orders, filters }: any) => {
          ...
          {!hasItems && (
            <div className="w-full">
              <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-300 bg-white p-8 text-center dark:border-neutral-700 dark:bg-neutral-900">
                <img src="/assets/images/fixedlogos/empty.png" alt="No orders" className="mb-4 h-44 w-44 object-contain" />
                <h3 className="text-lg font-semibold text-gray-800 dark:text-neutral-100">No orders found</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-neutral-400">Try adjusting your search or create a new order.</p>
                <div className="mt-4">
                  <button
                    onClick={() => router.get('/newbill')}
          ...
          {hasItems && (
            <div className="block md:hidden space-y-3">
              {orders.data.map((order: any) => (
                ...
                >
                  <div className="bg-linear-to-r from-red-50 to-orange-50 dark:from-neutral-700 dark:to-neutral-600 px-4 py-3 border-b border-gray-100 dark:border-neutral-600">
                    <div className="flex justify-between items-center">
                      <div className="flex-1 cursor-pointer" onClick={() => { setSelectedOrder(order); setDialogOpen(true); }}>
                        <div className="font-bold text-lg text-red-700 dark:text-red-400">#{order.order_number}</div>
                        <div className="text-xs text-gray-500 dark:text-neutral-400 mt-1">{dayjs(order.created_at).format('DD MMM YYYY, hh:mm A')}</div>
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-gray-50 dark:bg-neutral-700 rounded-lg p-3">
                          <div className="text-xs text-gray-500 dark:text-neutral-400 uppercase tracking-wide">Order Type</div>
                          <div className="mt-1">
                        ...
                        <div className="bg-gray-50 dark:bg-neutral-700 rounded-lg p-3">
                          <div className="text-xs text-gray-500 dark:text-neutral-400 uppercase tracking-wide">Payment</div>
                          <div className="mt-1">
                      ...
                      <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border border-green-200 dark:border-green-800">
                        <div className="flex items-center justify-between">
                          <span className="text-sm font-medium text-green-800 dark:text-green-300">Total Amount</span>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                    {orders.data.map((order: any, index: number) => (
                      <tr key={order.id}>
                        <td className="px-6 py-4 text-sm font-medium text-gray-800 dark:text-neutral-200 hidden lg:table-cell">{orders.from + index}</td>
                        <td
